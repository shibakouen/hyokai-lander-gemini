      ...
      <div className="max-w-[1240px] mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 items-stretch">
            ...
            <div className="ice-block rounded-[2rem] p-6 md:p-8 flex flex-col items-center hover:bg-blue-50/50 transition-all duration-300 transform hover:-translate-y-2 relative group h-full border border-blue-100/50">
                ...
                <p className="text-xs text-cb-blue mb-4 font-medium uppercase tracking-wider">{t.pricing.plans[0].tier}</p>
                ...
                <a href="https://app.hyokai.ai/pricing" className="w-full py-3 rounded-xl border border-cb-blue-light text-cb-blue-dark font-semibold hover:bg-cb-blue hover:text-white transition-colors bg-white/80 text-sm block text-center">
            ...
            <div className="rounded-[2.5rem] px-8 pb-8 pt-14 flex flex-col items-center bg-gradient-to-br from-slate-900 via-cb-blue-dark to-slate-900 text-white relative overflow-hidden shadow-2xl border border-white/10 transform md:scale-105 z-10 h-full">
                ...
                <h3 className="text-2xl font-semibold mb-2 relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-200">{t.pricing.plans[1].name}</h3>
                <p className="text-xs text-cyan-200/70 mb-4 font-medium uppercase tracking-wider relative z-10">{t.pricing.plans[1].tier}</p>
                ...
                <div className="text-5xl font-light mb-2 relative z-10 tracking-tighter text-white">
                    {t.pricing.plans[1].price.split('.')[0]}<span className="text-lg text-cyan-200/50 font-normal">.{t.pricing.plans[1].price.split('.')[1]}</span>
                </div>
                ...
                <ul className="space-y-4 mb-8 text-left w-full relative z-10 pl-2 text-sm flex-grow">
                    <li className="flex items-center gap-3 text-white font-bold text-base">
                        <i className="fa-solid fa-message text-cyan-400"></i> {t.pricing.plans[1].features[0]}
                    </li>
                ...
                <a href="https://app.hyokai.ai/pricing" className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-400 to-cb-blue text-white font-bold hover:shadow-[0_0_20px_rgba(34,211,238,0.5)] transition-all duration-300 relative z-10 border border-white/20 text-sm block text-center">
            ...
            <div className="ice-block rounded-[2rem] p-6 md:p-8 flex flex-col items-center hover:bg-emerald-50/50 transition-all duration-300 transform hover:-translate-y-2 relative group h-full border-2 border-emerald-100">
                <h3 className="text-xl font-medium text-slate-800 mb-2">{t.pricing.plans[2].name}</h3>
                <p className="text-xs text-emerald-600 mb-4 font-medium uppercase tracking-wider">{t.pricing.plans[2].tier}</p>
                <div className="h-1 w-12 bg-emerald-400 rounded-full mb-6"></div>

                <div className="text-4xl font-light text-slate-900 mb-2 tracking-tighter">{t.pricing.plans[2].price}</div>
                <div className="text-sm text-slate-500 mb-8">{t.pricing.month}</div>

                <ul className="space-y-4 mb-8 text-left w-full text-sm flex-grow">
                    <li className="flex items-center gap-3 text-slate-900 font-semibold">
                        <i className="fa-solid fa-message text-emerald-500"></i> {t.pricing.plans[2].features[0]}
                    </li>
                ...
                <a href="https://app.hyokai.ai/pricing" className="w-full py-3 rounded-xl border border-emerald-400 text-emerald-700 font-semibold hover:bg-emerald-500 hover:text-white transition-colors bg-white/80 text-sm block text-center">
            ...
            <div className="rounded-[2rem] p-6 md:p-8 flex flex-col items-center bg-gradient-to-b from-slate-950 to-deep-water text-white relative overflow-hidden shadow-xl border border-slate-700 group h-full">
                ...
                <a href="https://app.hyokai.ai/pricing" className="w-full py-3 rounded-xl border border-purple-500/50 text-purple-200 font-semibold hover:bg-purple-900/50 hover:text-white transition-colors bg-purple-900/20 text-sm block text-center">
